...
class directories(object):
    train = 'data/ADE_paths_train.h5'
    test = 'data/ADE_paths_test.h5'
    val = 'data/ADE_paths_val.h5'
    tensorboard = 'tensorboard'
    checkpoints = 'checkpoints/ADE'
    checkpoints_best = 'checkpoints/ADE/best'
    samples = 'val/ADE/'
